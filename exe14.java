/* 8 - Em um país imaginário denominado Lisarb, todos os habitantes ficam felizes em
...
recursos arrecadados são utilizados em benefício da população, sem qualquer desvio. 
 A moeda deste país é o Rombus, cujo símbolo é o R$. Leia um valor com duas casas 
...
sobre R$ 2.00, o que resulta em R$ 80.36 no total. O valor deve ser impresso com 
duas casas decimais */
...
public class exe14 {
    public static void main(String[] args) {
        ...
        if (renda <= 2000.0) {
            ...
            porcentagem = (renda - 2000.0) * 0.08;
        } else if (renda <= 4500.0) {
            porcentagem = (renda - 3000.0) * 0.18 + 1000.0 * 0.08;
        } else {
            porcentagem = (renda - 4500.0) * 0.28 + 1500.0 * 0.18 + 1000.0 * 0.08;
        }
        if (porcentagem == 0.0) {
